"""create_invoices_and_payments_tables

Revision ID: dc007ba0603e
Revises: 6b90e13f5c3d
Create Date: 2026-07-15 21:55:44.346248
...
revision: str = 'dc007ba0603e'
down_revision: Union[str, Sequence[str], None] = '6b90e13f5c3d'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('DRAFT', 'UNPAID', 'PARTIALLY_PAID', 'PAID', 'CANCELLED', name='invoicestatus'), nullable=False),
